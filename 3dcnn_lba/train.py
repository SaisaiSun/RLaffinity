...
def train(args, device, test_mode=False):
    ...
    pre_model.load_state_dict(torch.load('/Users/saisaisun/Downloads/mySimCLR/pth/model_stage1_epoch20.pth'), strict=False)
    #print(pre_model)
    #pre_model.to(device)
    in_channels = 32
    spatial_size = 21
...
if __name__=="__main__":
    ...
    parser.add_argument('--data_dir', type=str, default='/Users/saisaisun/Downloads/lba/dataset/NL_2020/split_bak1/data')
    parser.add_argument('--mode', type=str, default='test',
                        choices=['train', 'test'])
    parser.add_argument('--output_dir', type=str, default='/Users/saisaisun/Downloads/lba/dataset/NL_2020/split_bak1')
